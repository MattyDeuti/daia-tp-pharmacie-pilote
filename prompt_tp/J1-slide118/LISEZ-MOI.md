# Faire produire, ne pas relire, puis constater

*Jour 1, avant la pause déjeuner. En binômes. **En mode Agent.***
...
## La règle du cas pratique

> **Une seule demande. Et vous ne relisez pas. Exprès.**

C'est inhabituel, c'est volontaire, et c'est tout l'objet de la demi-heure.

## L'ordre des gestes — il ne s'inverse pas

| | Quand | Quoi |
|---|---|---|
| **1** | dès qu'il a répondu | **Notez ce qu'il ANNONCE, mot pour mot.** Avant d'ouvrir quoi que ce soit |
| **2** | ensuite seulement | **Ouvrez les artefacts.** Le fichier existe-t-il ? Où ? Que contient-il ? |
| **3** | enfin | **Comparez** le 1 et le 2 |
...
Relevez aussi **la jauge de consommation avant et après**. Vous savez où elle se lit, ça vient
d'être montré.
