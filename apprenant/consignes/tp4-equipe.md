...
> *(La demande toute prête est à la fin de votre fiche, dans `apprenant/prompt_tp/J2-slide206-couche-equipe/`.)*
...
> 🆘 **La demande complète est à la fin de votre fiche**, dans `apprenant/prompt_tp/J2-slide206-couche-equipe/`. N'y allez
...
> 🆘 **Une règle toute rédigée est à la fin de votre fiche**, dans `apprenant/prompt_tp/J2-slide206-couche-equipe/`. N'y
