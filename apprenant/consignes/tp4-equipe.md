...
> *(La demande toute prête est à la fin de votre fiche, dans `apprenant/prompt_tp/J2-slide250/`.)*
...
> 🆘 **Une règle toute rédigée est à la fin de votre fiche**, dans `apprenant/prompt_tp/J2-slide250/`. N'y
