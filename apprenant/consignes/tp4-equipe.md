...
> *(La demande toute prête est à la fin de votre fiche, dans `apprenant/prompt_tp/J2-slide242/`.)*
...
> 🆘 **La demande complète est à la fin de votre fiche**, dans `apprenant/prompt_tp/J2-slide242/`. N'y allez
...
> 🆘 **Une règle toute rédigée est à la fin de votre fiche**, dans `apprenant/prompt_tp/J2-slide242/`. N'y
