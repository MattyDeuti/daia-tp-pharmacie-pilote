...
|---|---|---|
| `tp1-legacy.md` | Auditer le legacy, puis générer et **exécuter** des tests | `prompt_tp/J1-slide194-audit-legacy/` |
| `tp2-spec.md` | Du besoin à la fonctionnalité : le workflow par spécification | `prompt_tp/J2-slide049-specification/` |
| `tp4-equipe.md` | `AGENTS.md` + workflow collaboratif (branche, PR, revue) | `prompt_tp/J2-slide202-couche-equipe/` |
...
- **la preuve attendue** : vous avez fini quand vous pouvez montrer ceci, pas quand vous le sentez
- **quoi faire si ça coince**, avec la sortie de secours
- **le défi bonus**, pour ceux qui finissent tôt
