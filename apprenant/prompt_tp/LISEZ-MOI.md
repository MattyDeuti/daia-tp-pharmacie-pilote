...
| `J2-slide184-votre-procedure/` | Demandez votre procédure, et comptez | 30 min | le nom de votre procédure, et si elle part toute seule |
| `J2-slide219-couche-equipe/` | La couche de l'équipe, en quatre briques | 25 min | le nom de votre branche |
